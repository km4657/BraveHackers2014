...
public class SMSServiceITCase {
    ...
    private final String accessToken = "jeqzwo3fbxrndgzn7kourp62wdurukr9";
    private final String number = "4042020149";
    private final String registrationId = "";

    @Test
    public void send() throws RESTException, JSONException 
