...
public class OAuthService {
     ...
     * @throws JSONException 
     */
    public OAuthToken getTokenUsingCode(String code) throws RESTException, JSONException {
        RESTClient client =
     ...
     * @throws JSONException 
     */
    public OAuthToken getToken(String scope) throws RESTException, JSONException {
        RESTClient client =
            new RESTClient(this.fqdn + API_URL)
            .addParameter("client_id", clientId)
            .addParameter("client_secret", clientSecret)
     ...
     */
    public OAuthToken refreshToken(String refreshToken) throws RESTException, JSONException {
        RESTClient client =
            new RESTClient(this.fqdn + API_URL)
            .addParameter("client_id", clientId)
            .addParameter("client_secret", clientSecret)
