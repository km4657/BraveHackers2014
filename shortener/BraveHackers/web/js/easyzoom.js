(function ($) {
    ...
    EasyZoom.prototype._init = function() {
        ...
        this.$target
            .on('mouseenter.easyzoom touchstart.easyzoom MSPointerDown.easyzoom', function(e) {
                if ( ! e.originalEvent.touches || e.originalEvent.touches.length === 1) {
                    e.preventDefault();
                    self.show(e);
                }
            })
				.on('mousemove.easyzoom touchmove.easyzoom MSPointerMove.easyzoom', function(e) {
                if (self.isOpen) {
                    e.preventDefault();
                    self._move(e);
                }
            })
            .on('mouseleave.easyzoom touchend.easyzoom MSPointerUp.easyzoom', function() {
                if (self.isOpen) {
                    self.hide();
                }
            });
    ...
    EasyZoom.prototype.show = function(e) {
        $('.easyzoom--overlay').css({'width':'100%'});
		var w1, h1, w2, h2;
        var self = this;
        if (! this.isReady) {
